          ...
          <button
            ...
            className={`rounded-md px-3 py-1.5 text-sm font-medium ${
              when === w
                ...
                : 'border border-border text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800/60'
            }`}
          >
              ...
              <Card className="h-full transition-shadow group-hover:shadow-md">
                <CardContent className="p-5">
                  <div className="flex items-start justify-between gap-2">
                    <h3 className="font-semibold text-slate-900 dark:text-slate-100 group-hover:text-indigo-600">
                      {s.title}
                    </h3>
                  ...
                  {s.theme && (
                    <p className="mt-2 text-sm text-slate-700 dark:text-slate-300">{s.theme}</p>
                  )}
                  {s.bibleRef && (
